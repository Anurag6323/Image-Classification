...
train_datagen = ImageDataGenerator(rescale=1./255)
training_set = train_datagen.flow_from_directory(r'data\test',
                                                target_size=(224, 224),
                                                batch_size=32,
                                                class_mode='categorical')

test_set = train_datagen.flow_from_directory(r'data\train',
                                                target_size=(224, 224),
                                                batch_size=32,
                                                class_mode='categorical')
...
im=image.load_img(r"data\test\adenocarcinoma\000113 (7).png",target_size=(224,224))
predict_image(im)
